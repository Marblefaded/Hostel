...
using Suo.Admin.Extentions.Logs;
using ILocalStorageService = Suo.Admin.Data.Services.ILocalStorageService;
...
public static class HostBuilderExtentions
{
    ...
    internal static IServiceCollection AddAppConfig(this IServiceCollection builder, IConfiguration configuration)
    {

        var appConfig = builder.GetApplicationSettings(configuration);
        builder.AddTransient<AppConfiguration>(e => appConfig);
        builder.AddJwtAuthentication(appConfig);

        return builder;
    }

    internal static IServiceCollection AddLocalStorage(this IServiceCollection builder)
    {

        builder.AddTransient<ILocalStorageService, LocalStorageService>();

        ServiceCollectionExtensions.AddBlazoredLocalStorage(builder);

        return builder;
    }
    internal static IServiceCollection AddServerAuthConfig(this IServiceCollection builder)
    {

        builder.AddHttpContextAccessor();
        builder.AddTransient<IHttpAuthenticationService, HttpAuthenticationService>();
        builder.AddScoped<AuthenticationStateProvider, HostelAuthenticationStateProvider>();
        return builder;
    }
