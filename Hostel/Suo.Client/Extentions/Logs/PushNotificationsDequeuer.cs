        ...
        private async Task DequeueMessagesAsync(CancellationToken stoppingToken)
        {
            ...
            do
            {
                ...
                if (!stoppingToken.IsCancellationRequested)
                {
                    ...
                    {
                        if (!EventLog.SourceExists("CUO.Blazor"))
                            EventLog.CreateEventSource("CUO.Blazor", "Critical Log");
                        EventLog.WriteEntry("CUO.Blazor", $"Exception - {e.Message}", EventLogEntryType.Error);
